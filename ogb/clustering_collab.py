...
from torch_geometric.utils import degree, to_dense_adj, k_hop_subgraph
...
def get_com():
    ...
    torch.save(lap_pe, 'collab_lap_pe_async_fluid.pt')
    ...
    if len(nets) > 1:
        ...
        com = asyn_fluidc(net, k=num_local)
    torch.save(com, 'collab_com_async_fluid.pt')
    torch.save(anchor_nodes, 'collab_anchor_async_fluid.pt')
...
def main():
    ...
    torch.save(ret, 'collab_pe_dict.pt')
    pos_enc = []
    ...
    torch.save(pos_enc, 'collab_pe_async_fluid.pt')
